            ...
            <div id="about_container">
                <Navbar />
                    ...
                    <div className="about_text">
                        ...
                        <p>I have a background in customer service which has given me excellent communication skills and interpersonal competence. I love working in a team environment and collaborating with other developers. I am proficient with HTML, CSS, JavaScript, React, Node and Express, and have relational database experience using SQL and PostgreSQL.</p> 
