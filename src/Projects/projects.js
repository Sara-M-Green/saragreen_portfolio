    ...
    render() {
        return (
            <div id="projects_container">
                    ...
                    {/* project 1 */}
                    <a className="project_link" href="https://sierra-summits.vercel.app/" target="blank"><h2 className="project_title">Sierra Summits</h2></a>
                    ...
                    {/* Project 2 */}
                    <a className="project_link" href="https://sara-m-green.github.io/ShelterDistillingSpiritQuiz/" target="blank"><h2 className="project_title">Shelter Distilling Spirits Quiz</h2></a>
                    ...
                    {/* Project 3 */}
                    <a className="project_link" href="https://sara-m-green.github.io/pow-now/" target="blank"><h2 className="project_title">Pow Now</h2></a>
                    ...
                    {/* Project 4 */}
                    <a className="project_link" href="https://turbotips.vercel.app/" target="blank"><h2 className="project_title">Turbo Tips</h2></a>
